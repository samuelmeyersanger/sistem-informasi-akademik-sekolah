...
class TentangController extends Controller
{
    ...
    public function storeOrUpdate(Request $request)
    {
        ...
        return redirect()->route('admin.tentang.index')->with('success', 'Informasi profil Tentang Sekolah berhasil diperbarui.');
    }
    ...
    public function destroy()
    {
        ...
        return redirect()->route('admin.tentang.index')->with('success', 'Data profil berhasil direset.');
    }
}