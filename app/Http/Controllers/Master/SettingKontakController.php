...
class SettingKontakController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('master.setting-kontak.index', compact('settings'));
    }
    ...
    public function storeOrUpdate(Request $request)
    {
        ...
        return redirect()->route('master.setting-kontak.index')->with('success', 'Pengaturan kontak informasi sekolah berhasil diperbarui.');
    }
}