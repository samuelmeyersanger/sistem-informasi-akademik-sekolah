...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('master.menu.index')->with('success', 'Menu baru berhasil ditambahkan secara live.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('master.menu.index')->with('success', 'Data konfigurasi menu berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('master.menu.index')->with('success', 'Menu berhasil dihapus dari sistem sidebar.');
    }
}