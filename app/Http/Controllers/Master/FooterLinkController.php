...
class FooterLinkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('master.footer-link.index', compact('links'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('master.footer-link.index')->with('success', 'Tautan footer baru berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, FooterLink $footerLink)
    {
        ...
        return redirect()->route('master.footer-link.index')->with('success', 'Data tautan footer berhasil diperbarui.');
    }
    ...
    {
        $footerLink->delete();
        return redirect()->route('master.footer-link.index')->with('success', 'Tautan footer berhasil dihapus permanen.');
    }
}