<x-app-layout>
    ...
    <div class="max-w-5xl space-y-6">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100">
            ...
            <form action="{{ route('admin.pengaturan-logo.save') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="border border-gray-100 p-4 rounded-xl bg-gray-50/30 flex flex-col justify-between">
                        <div>
                            ...
                            <input type="file" name="logo_pemda" class="w-full text-xs text-gray-500 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                        </div>
                        <div class="mt-4 flex items-center justify-center p-3 bg-white border border-gray-100 rounded-lg min-h-[100px]">
                            @if($logoSetting->logo_pemda)
                    ...
                    <div class="border border-gray-100 p-4 rounded-xl bg-gray-50/30 flex flex-col justify-between">
                        <div>
                            ...
                            <input type="file" name="logo_sekolah" class="w-full text-xs text-gray-500 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                        </div>
                        <div class="mt-4 flex items-center justify-center p-3 bg-white border border-gray-100 rounded-lg min-h-[100px]">
                            @if($logoSetting->logo_sekolah)
                    ...
                    <div class="md:col-span-2 border border-gray-100 p-4 rounded-xl bg-gray-50/30">
                        ...
                        <input type="file" name="kop_surat" class="w-full text-xs text-gray-500 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                        <div class="mt-4 flex items-center justify-center p-3 bg-white border border-gray-100 rounded-lg min-h-[120px]">
                            @if($logoSetting->kop_surat)
                    ...
                    <div class="border border-gray-100 p-4 rounded-xl bg-gray-50/30 flex flex-col justify-between">
                        <div>
                            ...
                            <input type="file" name="ttd_kepala_sekolah" class="w-full text-xs text-gray-500 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                        </div>
                        <div class="mt-4 flex items-center justify-center p-3 bg-white border border-gray-100 rounded-lg min-h-[100px]">
                            @if($logoSetting->ttd_kepala_sekolah)
                    ...
                    <div class="border border-gray-100 p-4 rounded-xl bg-gray-50/30 flex flex-col justify-between">
                        <div>
                            ...
                            <input type="file" name="stempel_sekolah" class="w-full text-xs text-gray-500 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                        </div>
                        <div class="mt-4 flex items-center justify-center p-3 bg-white border border-gray-100 rounded-lg min-h-[100px]">
                            @if($logoSetting->stempel_sekolah)
                    ...
                    <div class="md:col-span-2 border border-gray-100 p-4 rounded-xl bg-gray-50/30">
                        ...
                        <input type="file" name="ttd_dan_stempel" class="w-full text-xs text-gray-500 file:mr-4 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                        <div class="mt-4 flex items-center justify-center p-3 bg-white border border-gray-100 rounded-lg min-h-[120px]">
                            @if($logoSetting->ttd_dan_stempel)
