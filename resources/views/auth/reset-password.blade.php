        ...
        <div class="w-full bg-white p-6 md:p-8 rounded-2xl border border-gray-100 shadow-xl shadow-gray-100/70">
            ...
            <div class="mb-5 text-center">
                ...
                <p class="text-[10px] font-bold text-indigo-600 uppercase tracking-widest mt-0.5">
                    SIAS Pembaruan Sandi Akun
                </p>
                <p class="text-xs text-gray-500 mt-1.5 max-w-xs mx-auto leading-relaxed">
                    Silakan masukkan kata sandi baru Anda untuk memulihkan akses masuk ke sistem.
                </p>
            </div>

            <form method="POST" action="{{ route('password.store') }}" x-data="{ showNewPass: false, showConfirmNewPass: false }" class="space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative rounded-xl shadow-sm">
                        ...
                        <button type="button" 
                            ...
                            <span x-show="showNewPass" style="display: none;">🔒</span>
                        </button>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative rounded-xl shadow-sm">
                        ...
                        <button type="button" 
                                ...
                                class="absolute inset-y-0 right-0 pr-3 flex items-center text-xs text-gray-400 hover:text-indigo-600 focus:outline-none transition-colors">
                            <span x-show="!showConfirmNewPass">👁️</span>
                            <span x-show="showConfirmNewPass" style="display: none;">🔒</span>
                        </button>
                    </div>
            ...
            <div class="mt-6 pt-4 border-t border-gray-100 text-center">
                <a href="{{ route('login') }}" class="text-xs font-semibold text-indigo-600 hover:text-indigo-500 transition-colors inline-flex items-center gap-1">
