        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100">
                    ...
                    <form action="{{ route('master.tentang.save') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
                        @csrf
                        ...
                        <div class="pt-4 border-t border-gray-100 flex justify-between items-center">
                            @if($tentang)
                                <button type="submit" name="action" formaction="{{ route('master.tentang.reset') }}" onclick="return confirm('Apakah Anda yakin ingin mereset data profil ini?')" class="text-xs font-medium text-rose-600 hover:underline cursor-pointer">
                                    🗑️ Kosongkan Data
                                </button>
                            @else
                                <div></div>
